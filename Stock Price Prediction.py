...
x_train=[] y_train=[]
for i in range(100,data_training_array.shape[0]): x_train.append(data_training_array[i100:i]) y_train.append(data_training_array[i,0])
...
True,input_shape=(x_train.shape[1],1))) model.add(Dropout(0.2))
